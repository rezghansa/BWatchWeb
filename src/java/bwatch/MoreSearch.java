 ...
 * @author hansa
 */
@WebServlet(name = "MoreSearch", urlPatterns = {"/MoreSearch"})
public class MoreSearch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String searchQuery = "select * from jobs where jobStatus like 'A'";
